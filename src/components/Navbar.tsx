    ...
    >
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center space-x-6">
          <a href="https://github.com/VIJAYAPANDIANT" target="_blank" rel="noopener noreferrer" aria-label="GitHub" title="GitHub" className="text-gray-500 hover:text-neon-blue transition-colors">
            <Github size={16} />
          </a>
          <a href="https://linkedin.com/in/vijayapandian-t" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" title="LinkedIn" className="text-gray-500 hover:text-neon-blue transition-colors">
            <Linkedin size={16} />
          </a>
